=== Followup - Follow-Up Emails for WooCommerce ===
...
Plogins Followup includes Polish, German and Spanish translations for the plugin interface. The text domain is `plogins-followup`, so WordPress.org language packs can also override or extend these bundled translations.
